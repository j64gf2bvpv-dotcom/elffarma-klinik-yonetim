              ...
              {payments.map((payment) => (
                <TableRow key={payment.id}>
                  ...
                  <TableCell className="font-medium">
                    <Link to={`/cari-hesap/${payment.customer_id}`} className="hover:underline">
                  ...
                  <TableCell className="text-right">
                    <Button variant="ghost" size="icon" title="Cari Hesabı Görüntüle" asChild>
                      <Link to={`/cari-hesap/${payment.customer_id}`}>
