    ...
    <NavLink
      ...
      className={({ isActive }) =>
        cn(
          ...
          // aynı kök neden) — seçili panel her zaman belirgin şekilde
          // koyulaşsın diye sabit, güçlü bir siyah katman kullanılıyor.
          isActive
            ? 'bg-black/55 text-sidebar-accent-foreground shadow-[0_1px_0_rgba(255,255,255,0.15)_inset,0_4px_10px_-2px_rgba(0,0,0,0.6)]'
