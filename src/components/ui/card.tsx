...
function Card({ className, ...props }: React.ComponentProps<'div'>) {
  return (
    <div
      data-slot="card"
      className={cn(
        'bg-card/90 supports-[backdrop-filter]:backdrop-blur-xl text-card-foreground flex flex-col gap-4 rounded-xl border border-border/60 shadow-[0_1px_0_rgba(255,255,255,0.5)_inset,0_1px_2px_rgba(0,0,0,0.04),0_20px_44px_-24px_rgba(0,0,0,0.22)] ring-1 ring-black/[0.02] transition-all duration-300 hover:shadow-[0_1px_0_rgba(255,255,255,0.5)_inset,0_1px_2px_rgba(0,0,0,0.04),0_28px_56px_-24px_rgba(0,0,0,0.28)]',
        className,
      )}
      {...props}
    />
