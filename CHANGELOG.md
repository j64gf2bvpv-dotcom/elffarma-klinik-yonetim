...
**Stok'ta Güncel Stok Durumu'nda Paket/Flakon ortalama düzeltildi:** Paket ve Flakon değerleri artık iki sabit genişlikli sütun olarak ortadaki çizgiye göre gerçekten ortalı — önceki sürümde sadece sol hizalıydı, kullanıcı geri bildirimiyle tam ortalanacak şekilde düzeltildi (rakamlar satırdan satıra kaysa da ayraç çizgisi her zaman aynı yerde kalıyor). Şema değişikliği yok.

## [2.17.265] - 2026-08-28

**Stok'ta ürün listesi tablosu baştan sona düzenlendi:** Ürün adından itibaren tüm sütunlar arasına tam boy tablo çizgisi eklendi (sürükle/seç/görsel gibi küçük yardımcı sütunlar arasına eklenmedi). Kategori/Paket/Flakon/Fiyat/Kampanya/SKT/İşlemler içerikleri ortalandı. Süresi geçen/yaklaşan ürünlerde takvim ikonu kaldırıldı, sadece SKT rozeti kırmızı/turuncu kalıyor. Güncel Stok Durumu'nda Paket/Flakon arası ayraç sabit, sol hizalı bir sütun halinde (ortalanmadan) tutarlı kalıyor. Her satırın en başına, kataloğun kendi sırasına göre 1'den başlayan bir numara eklendi — toplam ürün sayısını son numaraya bakarak görebilirsiniz. Şema değişikliği yok.
...
**Günün Satış / İade Hareketleri'nde düzenleme ve toplu silme eklendi:** Her satırda artık bir düzenle (kalem) butonu var — doktor, ürün, adet gibi bilgileri değiştirebilirsiniz (stok buna göre otomatik düzeltilir: eski kayıt geri alınıp yeni haliyle yeniden uygulanır). Kart başlığına, o güne ait tüm satış/iade kayıtlarını tek seferde silen bir "Tümünü Sil" butonu eklendi (her kayıt için stok ayrı ayrı geri düzeltilir). Şema değişikliği yok.
...
**Satış içe aktarmada eksik satırlar artık hata göstermiyor:** Tarih/Doktor/Ürün/Adet'ten biri boş bırakılmış satırlar (kullanılmayan şablon satırları, elle doldururken atlanan hücreler) artık "hata" olarak işaretlenmiyor — sessizce atlanıyor, doğru dolu satırlar her zamanki gibi ekleniyor. Doktor/ürün adı bulunamadı veya geçersiz tarih/adet gibi gerçek sorunlar hâlâ hata olarak gösteriliyor. Şema değişikliği yok.
...
**Satış düzenlemede de birden fazla ürün eklenebiliyor:** Önceki sürümde satır düzenleme sadece tek ürünlüydü. Artık "Yeni Satış / İade" ile aynı şekilde, düzenlerken de ürün satırı eklenip çıkarılabiliyor — kaydedince eski kayıt silinip formdaki her ürün için ayrı bir kayıt oluşturuluyor.
...
**Kongre/Workshop sevkiyatında Kapalı Dönen / Açık Dönen artık "Sevkiyat Ekle" ekranında da girilebiliyor** (Kullanılan otomatik hesaplanıp canlı gösteriliyor) — önceden sadece sevkiyat kaydedildikten sonra tabloya tıklayarak girilebiliyordu. **Günlük Sayım'da dünkü sayımdan az bir miktar girilirse artık uyarı çıkıyor:** "Dikkat — ... dünkü sayımdan az. Devam edilsin mi?" (Vazgeç / Tamam, Devam Et) — yanlışlıkla eksik girilen sayımları yakalamak için.
